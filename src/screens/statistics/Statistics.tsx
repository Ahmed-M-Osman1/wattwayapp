          ...
          {loading ? <Spinner size={scale(30)} style={style.spinner} color={commonColors.disabledDark} /> : (
            <View style={style.boxContainer}>
              ...
              <StatisticsComponent
                ...
                description={t('home.totalConsumptionNote')}
              ...
              <StatisticsComponent
                ...
                description={t('home.totalDurationNote')}
              />
              <StatisticsComponent
                ...
                description={t('home.totalInactivityNote')}
              />
              {isPricingActive && (
                <StatisticsComponent
                  ...
                  description={t('home.totalPriceNote')}
                />
              )}
            </View>
          )}
